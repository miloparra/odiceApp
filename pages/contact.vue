<template>
  <div class="grid grid-cols-5 gap-4">
    ...
    <form @submit.prevent="submitForm" class="flex justify-center items-center col-span-3">
      <div>
        ...
        <div class="flex justify-center items-center">
          <div class="grid col-2 gap-5">
            ...
            <textarea v-model="form.moreInfo" type="text" class="col-span-2 h-30 border border-gray-300 rounded-[20px] p-2 px-6" placeholder="Informations complémentaires"></textarea>
          </div>
        </div>
